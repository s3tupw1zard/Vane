    ...
    return (
      ...
      >
        <select
          ...
          className={cn(
            'bg-light-secondary text-black dark:bg-dark-secondary dark:text-white px-3 py-2 flex items-center overflow-hidden border border-light-200 dark:border-dark-200 rounded-lg appearance-none w-full pr-10 text-xs lg:text-sm',
            className,
          )}
        >
