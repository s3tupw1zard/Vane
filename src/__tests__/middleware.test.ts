...
describe('Middleware — requireAuth', () => {
  ...
  it('returns user when token is valid', async () => {
    const mockUser = { id: 'user-123', username: 'test', role: 'user' as UserRole, sessionId: 'sess-456' };
...
describe('Middleware — requireAdmin', () => {
  ...
  it('returns 403 when user is not admin', async () => {
    const nonAdminUser = { id: 'user-123', username: 'test', role: 'user' as UserRole, sessionId: 'sess-456' };
  ...
  it('returns user when admin token is valid', async () => {
    const adminUser = { id: 'admin-123', username: 'admin', role: 'admin' as UserRole, sessionId: 'sess-789' };
